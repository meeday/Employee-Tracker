// mysql module required
const mysql = require('mysql');

// import server details
const details = require("../config/connection");
// function to get create new connection
...
// query class contains all the methods and sql commands to get the required data
class QUERY {
// methods to get the different data from the database
  ...
  async getAllEmployeesFullData() {
    ...
    LEFT JOIN roles AS roles ON employee.role_id = roles.id
...
// class exported for use in the usersearch file 
